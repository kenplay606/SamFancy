...
export default function InteractiveMenu() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-start justify-center py-8 px-3">
      <div className="relative w-full max-w-md md:max-w-5xl bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] shadow-2xl rounded-3xl border border-[#2a2a2a] overflow-hidden">
